...
updated_at: "2026-09-26T09:28:02.171Z"
---
...
원하는 등록 축제를 찾아 방문 흐름·관광자원·개최 시기를 같은 화면 구조로 이용할 수 있다. 공식 API의 2023-01~2026-08 방문 보관 자료를 현재 조회단위269곳에 연결하고 축제 등록867건을 확보했으며 매일 갱신한다. 최신 관측은2026-08-27이고 지역별 결측은 유지한다. 검토된 임실·논산 회차는 현재 등록 축제 안에서 비교하며 기존 보조 분석을 유지한다. 실제 Opus5.5 위임 후 직접 검수, 단위357·기존headless22+신규16항목·ARC·공개 네 축제 원자료/세 메뉴·업무 보존 확인을 마쳤다. D:\download\project\pickDday\index.html의 최종v2에서 공통 화면 목표·실제 화면을 먼저 볼 수 있다.
