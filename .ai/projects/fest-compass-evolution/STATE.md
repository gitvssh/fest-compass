...
updated_at: "2026-09-24T12:35:20.991Z"
---
...
임실 2023·2024·2025년 성·연령 비율·목적지 검색순위를 기존 축제 방문 흐름에서 비교할 수 있다. 한 회차/두 회차 표시와 현재 자원 연결, 하루 평균·외지인 비율 변화가 공개 사용 가능하다. 세 회차 선택은 유지하고 상세는 최근 두 회차를 비교한다. 실제 Opus5.5 위임과 직접 검수, 단위342·headless22스크립트·ARC·공개 데이터·업무 보존 확인을 마쳤다. D:\download\project\pickDday\index.html에서 새 비교 화면과 기본 설계를 확인할 수 있다. 최종 시각 디자인·실무자 관찰·전국 확대·거주지·예약 수집은 후속이다.
...
- 두 핵심 흐름·관련 자료 검색·임실 방문 구성/연간 추세·임실 2023~2025년 성·연령/목적지 순위와 두 회차 비교·현재 관광자원 연결은 사용 가능하다. 최종 시각 디자인·실제 담당자 업무 관찰은 후속이다. 외부 검색 결과 적합성·원문 내용은 미검증이며 AI 요약은 나중에 검토한다. 추가 방문 영역의 320/390/1440px·키보드 출처창·초점은 확인했으나 전체 보조기술·200% 확대는 후속이다.
- 보존한 나머지 277개 CSV의 지표 계약·실제 연결과 Foundry 연계·자료 자동 갱신은 후속이다. 논산딸기축제는 새 26개 연도별 목록에 없고 기존 시군구 방문 이력과 별도로 다룬다. 임실 2023·2024·2025년은 각 공식 응답 다섯 개와 조회 조건으로 기간·성수면을 확인했다. 축제별 거주지는 미확보이며 다른 축제/연도도 기간·공간을 확인한 자료가 필요하다. 수집 도구는 검토용 후보만 만들며 자동 게시하지 않는다.
