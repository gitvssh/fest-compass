...
version: v8
summary: "두 목적의 검색·회차·지역·관측연월·달력 연결과 조건 복귀·조회 실패를 구체화합니다. 기존 축제 흐름의 구현·검증은 기록34를 따르고 새 축제 전용 흐름은 후속입니다."
---
...
최종 시각 디자인은 사용자 작업이다. 기존 축제의 현재 구현·실행 검증은 [검증 기록](../../validation/34-existing-festival-journey.md)을 따르며 새 축제 전용 흐름은 후속이다.
...
이 도식은 조회·복구 계약이다. 기존 축제의 실제 판정은 TS-FC-009와 검증 기록을 따르고 새 축제에는 후속 적용한다.
