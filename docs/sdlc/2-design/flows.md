...
version: v7
summary: "두 목적의 검색·회차·지역·관측연월·달력 연결과 조건 복귀·조회 실패를 구체화합니다. 새 흐름은 개발 전 계획이며 기존 구현 이력은 별도로 보존합니다."
---
...
이번 변경은 기능·기획과 기본 배치까지이며 최종 시각 디자인과 앱 구현은 후속이다.
...
이 도식은 미구현 계약이며 아래 v5·v6 정상 여정과 함께 인수한다.

2026-09-22 [기획 기준](../../product/planning-principles.md)에 맞춰 기존 축제 개선 v5에 새 축제 기획 v6를 연결한다.
아래 v5·v6 도식은 **미구현 계획**이며 화면 ID는 [화면 레지스터](screens.md)를 참조한다.
