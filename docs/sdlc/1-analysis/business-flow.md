...
아래는 기록을 선택한 담당자의 기존 업무 가설이다. 시작은 올해 행사 방향과 예산을 검토하는 시점이고,
기획안·결과 보관까지 이어지는 경우를 다룬다. 조회·비교만으로 이용을 마칠 수도 있으며 보관 완료가 전체 제품의 필수 종료 조건은 아니다.
실제 부서별 결재·계약 절차를 제품이 대신하지 않는다.
이 흐름은 초기 기획의 D-90~D+14 여정을 확장한 업무 가설이며 현장 관찰은 미실시다.

2026-09-22 [확정 원칙](../../product/planning-principles.md)은 기존 축제 개선·새 축제 기획의 두 흐름과 선택적 기록이다.
현재 화면의 연결·제약은 [현행 점검](../../review/2026-09-current-state.md)을 따르며, 아래 도식을 새 두 목적의 확정 화면 흐름으로 읽지 않는다.
...
| 업무 | 담당자가 확인할 내용 | pickDday에서 남길 자료 | 외부 조직에서 수행할 일 |
|---|---|---|---|
