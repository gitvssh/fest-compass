...
로컬 구현·자동 검증을 마쳤고 공개 반영은 진행 중이다. 기준 앱 커밋은 `28c06973ba31db8d132eaedbe6de5b4e09cb3723`이며,
[기능 상세](../sdlc/2-design/functional-spec.md)와 [인수 시나리오](../sdlc/3-testing/scenarios/TS-FC-009.md)를 따른다.
Claude Opus 5.5에 자료 처리·화면 구현·인수 시험 작성을 위임하고 통합 담당이 원자료·코드·실행 화면을 직접 검수한다.
...
공개 운영의 실제 조회·배포·보관 데이터 대조 결과는 반영 후 추가한다. 기존 예측 모델·보관 원자료·운영 업무 데이터는 변경 대상이 아니다.
