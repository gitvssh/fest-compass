...
2026-09-09 [공식 경계 원본·코드 대조](../sdlc/2-design/region-boundary-contract.md)를 추가했다. 269개 조회 단위 중 명칭 일치 후보 221·합성 후보 12·미연결 36개다. 다음 M1 보완은 공식 연계표→표본 형상 검증→경계 레이어·기준일·미연결 안내이며, 원본 확보를 화면 연결 완료로 표시하지 않는다.
