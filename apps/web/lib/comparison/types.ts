...
export type Edition = {
  ...
  missing: string[]; statusSource?: Source; discoveredWith?: SearchContext; point?: Point;
};
export type SearchContext = { mode: "archive" | "current"; regions: string[]; start: string; end: string; keyword: string; theme: string; dateRule: "overlap" | "starts-within"; queriedAt: string | null; distance?: DistanceCondition };
