  ...
  return <div className="space-y-6">
    ...
    <div className="grid items-start gap-5 lg:grid-cols-[290px_minmax(0,1fr)]">
      ...
      <div className="min-w-0 space-y-4">
        ...
        </form><p className="mt-3 text-xs leading-5 text-muted">최대 366일. 축제·행사는 이 기간과 <strong>겹치는 일정의</strong> 등록 자료를 조회합니다. 관광지·문화시설은 현재 등록 목록이며 과거 영업·사용 가능 여부를 뜻하지 않습니다.</p></section>
