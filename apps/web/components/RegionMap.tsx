...
export type RegionMapProps = { province: string; district: string; resources: Resource[]; selected: string; appliedBounds?: Bounds | null; onProvince: (code: string) => void; onDistrict: (code: string) => void; onBoundary: (value: BoundaryReference | null) => void; onResource: (id: string) => void; onBounds: (bounds: Bounds | null) => void };
...
export function RegionMap(props: RegionMapProps) {
  ...
  useEffect(() => { if (simple) props.onBoundary(null); }, [simple, props.onBoundary]);
